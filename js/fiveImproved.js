(function(andRedEyelikeTicketMaster, undefined) {
    ...
    SL.andRedEyelikeTicketMaster = {
        ...
        pgCssDesktop: function() {
            ...
            var mainCss = ' #btog{display:none}a#modeIsm.cButton.cButton--primary.cButton--outlined.cButton--icontext.bloc{display:block}.edp__section_header .cButton--primary{display:inline-block;border:none;line-height:38px;vertical-align:middle}a#modeIsm.cButton.cButton--primary.cButton--outlined.cButton--icontext{border:none}button.cButton.cButton--primary.cButton--outlined.cButton--icontext{border:none}.cButton--outlined.cButton--primary,.cButton--primary.cButton--link{border:none}.cButton--icontext span{vertical-align:top;line-height:38px}.edp__section_header .cButton--primary{display:inline-block;border:none}@media screen and (max-width: 650px){#noseats{display:none}.mainfooter{margin-top:0}.edpcontent{min-height:160px}} ';
        ...
        removeToggle: function() {
            ...
            if(window.location.hostname === 'www.ticketmaster.de') { 
                if (document.querySelectorAll('.ticketpriceinfo__actions').length > 0) {
                    ...
                    //buttonClean
                    var te = document.querySelector('#ticketselection .ticketpriceinfo__actions button');
                    te.id ='buttonclean';   
                    ...
                    says2.innerHTML +=  message;      
                        ...
                        bringBack(); 
                        //buttonClean
                        var de = document.querySelector('#modeIsm.cButton.cButton--primary.cButton--outlined.cButton--icontext'); 
                        de.classList.add('buttonclean');   
